...
final class Version20240730151757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE missions (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, nom VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, slug VARCHAR(100) NOT NULL, tarif INT DEFAULT NULL, start_date_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', end_dateat DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', duree INT NOT NULL, is_pourvue TINYINT(1) NOT NULL, i_steletravail TINYINT(1) NOT NULL, lieu_mission VARCHAR(100) NOT NULL, is_active TINYINT(1) NOT NULL, experience INT NOT NULL, INDEX IDX_34F1D47E67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
