...
final class Version20240913131054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE missions CHANGE start_date_at start_date_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', CHANGE duree duree INT NOT NULL, CHANGE lieu_mission lieu_mission VARCHAR(100) NOT NULL, CHANGE experience experience INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE missions CHANGE start_date_at start_date_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', CHANGE duree duree INT DEFAULT NULL, CHANGE lieu_mission lieu_mission VARCHAR(100) DEFAULT NULL, CHANGE experience experience INT DEFAULT NULL');
    }
}
